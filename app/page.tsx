...
import { FaUserPlus, FaLaptopCode, FaVideo, FaBookOpen, FaMapMarkerAlt } from 'react-icons/fa';
import { useLanguage } from '@/context/LanguageContext';

export default function Home() {
  // t() এর বদলে language নিচ্ছি, যাতে সরাসরি লাইনের মধ্যেই বাংলা/ইংরেজি লেখা যায়
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10">
            ...
            <div className="lg:w-3/5 text-center lg:text-left space-y-5">
              <div className="inline-block bg-amber-400 text-slate-950 px-3 py-1 rounded-full font-black text-xs md:text-sm uppercase tracking-wider shadow-lg">
                {language === 'BN' ? "ভর্তি চলছে — শিক্ষাবর্ষ ২০২৬" : "Admissions Open — Academic Year 2026"}
              </div>
              ...
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-black leading-tight bg-gradient-to-r from-white via-amber-200 to-purple-200 bg-clip-text text-transparent animate-color-shift">
                {language === 'BN' ? "আপনার সন্তানের উজ্জল ভবিষ্যৎ আমাদের অঙ্গীকার" : "Your Child’s Bright Future Is Our Commitment"}
              </h1>
              ...
              <p className="max-w-xl mx-auto lg:mx-0 leading-relaxed bg-gradient-to-r from-slate-200 via-amber-100 to-slate-100 bg-clip-text text-transparent text-base md:text-lg animate-color-shift">
                {language === 'BN' 
                  ? "আধুনিক ডিজিটাল ল্যাব, সিসি ক্যামেরা নিয়ন্ত্রিত ক্যাম্পাস এবং নৈতিক শিক্ষার সমন্বয়ে মিরপুরের শ্রেষ্ঠ বিদ্যাপীঠ। প্লে থেকে দশম শ্রেণি পর্যন্ত ভর্তি চলছে!" 
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3 mt-5">
                <FeatureBadge icon={<FaLaptopCode />} text={language === 'BN' ? "ডিজিটাল ল্যাব" : "Digital Lab"} />
                <FeatureBadge icon={<FaVideo />} text={language === 'BN' ? "সিসি ক্যামেরা" : "CCTV Campus"} />
                <FeatureBadge icon={<FaBookOpen />} text={language === 'BN' ? "আরবি সম্পূর্ণ ফ্রি" : "Arabic Classes Free"} />
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
                ...
                >
                  <span className="relative z-10 flex items-center justify-center gap-2 bg-amber-400 hover:bg-amber-500 text-slate-950 px-8 py-4 rounded-full font-black text-lg transition-all shadow-[0_0_20px_rgba(251,191,36,0.3)] group-hover:scale-105 active:scale-95">
                    <FaUserPlus className="transition-transform group-hover:rotate-12"/> 
                    {language === 'BN' ? "এখনই ভর্তি হোন" : "Apply Now"}
                  </span>
                </Link>
                
                {/* REPLACED BUTTON WITH LOCATION */}
                <a 
                  href="https://maps.app.goo.gl/sBdCPg7BnvzHGTWm7" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white border border-white/20 px-8 py-4 rounded-full font-bold text-sm md:text-base backdrop-blur-md transition-all shadow-lg"
                >
                  <FaMapMarkerAlt className="text-amber-400 text-lg" />
                  {language ===  'BN' ? "Google Map: ২৯ আল মদিনা রোড, মিরপুর-১" : "Google Map: 29 Al Madina Road, Mirpur-1"}
                </a>
              </div>
            </div>
            ...
            <div className="lg:w-2/5 w-full relative flex justify-center lg:justify-end mt-8 lg:mt-0">
              <div className="w-full max-w-md bg-white/10 p-3 rounded-[2rem] backdrop-blur-md border border-white/20 shadow-2xl relative">
                <div className="relative w-full h-64 md:h-80 rounded-3xl overflow-hidden bg-gray-100">
                  <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3650.5983460988937!2d90.35824551536269!3d23.79731309290065!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c11030e468db%3A0xcf95cb016c026e64!2sAl-Madina%20Rd%2C%20Dhaka!5e0!3m2!1sen!2sbd!4v1684305080000!5m2!1sen!2sbd" 
...
// Function এর শেষে Closing Bracket যুক্ত করা হয়েছে
